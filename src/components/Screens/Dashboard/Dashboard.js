...
const Dashboard = (props) => {
  ...
  if (isLoading && analyticsLoader) content = <Spinner />;
  ...
  if (
    ...
    content = (
      <div className={classes.contentMain} style={{ alignItems: "center" }}>
      ...
      <div className={classes.contentMain}>
        ...
        <div className={classes.contentMainArticles}>
          <div className={classes.articlesHeading}>
            <p className={classes.articlesHeadingText}>articles</p>
          </div>
          <div className={classes.ScrollableContainer}>
            ...
            {!pageLoader && !analyticsLoader ? (
              articles.map((article, index) => {
                ...
                if (index < 5)
                  returnedArticle = (
                    <div className={classStyling.join(" ")} key={article._id}>
                      <p
                        className={[
                      ...
                      >
                        {article.headline.main.substring(0, 150)}...
                      </p>
                      <p
                        className={[
                          classes.articlesColumns,
        ...
        <div className={classes.contentToggle}>
          <span className={classes.contentToggleText}>
            Check out the articles in detail in the{" "}
            <NavLink
              to="/articles"
          ...
          <ul className={classes.contentToggleList}>
            {pages.map((page) => {
              ...
              if (selectedPage === page) styles.push(classes.selectedItem);
      ...
      >
        ...
        <div className={classes.contentSearch}>
          <img
            ...
            alt="Search"
          />
          <form onSubmit={submitSearch} className={classes.formStyling}>
            <input
              ...
              style={
                searchQuery
                  ? {
                      ...
                      boxShadow:
                        "0 0 .5rem 0.05rem var(--color-border-sidebar)",
                    }
                  : null
              }
            >
