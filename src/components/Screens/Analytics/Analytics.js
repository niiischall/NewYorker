...
const Analytics = (props) => {
  ...
  const isLoading = useSelector(
    (store) => store.analytics.detailedAnalyticsLoader
  );
      ...
      <div className={classes.contentMain} style={{ alignItems: "center" }}>
        ...
        <div className={classes.contentMainHeadline}>
          <p className={classes.contentMainHeadlineText}>
            We can't seem to find any searches yet. Check out our{" "}
            <NavLink
              to="/home"
      ...
      >
        <div style={{ display: "flex", width: "100%" }}>
          ...
          <p className={classes.contentHeadingText}>
            Analytics on the topic of{" "}
            <span className={classes.Bold}>"{searchedQuery}"</span>, brought to
            you by <span className={classes.Bold}>NYTimes.com</span>...
          </p>
        </div>
      </div>
    );
