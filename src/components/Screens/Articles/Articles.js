      ...
      <div className={classes.contentMain} style={{ alignItems: "center" }}>
        <div className={classes.contentMainHeadline}>
          <p className={classes.contentMainHeadlineText}>
            We can't seem to find any searched articles yet. Check out our{" "}
            <NavLink
              to="/home"
    ...
    content = (
      <div>
        <p className={classes.contentHeadingText}>
          Articles on <span className={classes.Bold}>"{searchedQuery}"</span>{" "}
          brought to you by <span className={classes.Bold}>NYTimes.com</span>...
        </p>
